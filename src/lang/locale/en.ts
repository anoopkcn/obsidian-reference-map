...
export default {
    ...
    COPY_TITLE_DESC: "Add the title (if present) of the reference to the clipboard.",
    COPY_PAPER_DOI: "Copy paper DOI",
    COPY_PAPER_DOI_DESC: "Add the DOI (if present) of the reference to the clipboard.",
    COPY_AUTHORS: "Copy authors",
    COPY_AUTHORS_DESC: "Add the authors (if present) of the reference to the clipboard.",
    COPY_YEAR: "Copy year",
    COPY_YEAR_DESC: "Add the year (if present) of the reference to the clipboard.",
    COPY_ABSTRACT: "Copy abstract",
    COPY_ABSTRACT_DESC: "Add the abstract (if present) of the reference to the clipboard.",
    COPY_URL: "Copy URL",
