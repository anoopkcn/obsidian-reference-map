...
export default {
    ...
    FIND_CITEKEY_WITHOUT_PREFIX_DESC: "Find citekey without <code>@</code> prefix in WikiLinks and Markdown Links. This does NOT disable citekey detection with <code>@</code> prefix.<br>" +
