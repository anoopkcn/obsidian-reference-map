...
*Enable this feature from the settings. Note that, one has to provide a `Better BibTex CSL JSON` or `Bibtex CSL JSON` or `CSL JSON` or file to enable this feature. Once enabled, the plugin can recogonize the pandoc citation format.
